...
namespace EReaderApp.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdReview,Comment,FKIdBook,FKIdUser")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdReview,Comment,FKIdBook,FKIdUser")] Review review)
        {
